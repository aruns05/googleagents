...
def print_before_agent_callback_message(callback_context: CallbackContext):
    ...
    print("QNA_CREATOR_print_before_agent_callback_message_arun:", callback_context.agent_name,callback_context.state.get('qna_results'))
    
def print_after_agent_callback_message(callback_context: CallbackContext):
    print("QNA_CREATOR_print_after_agent_callback_message_arun:", callback_context.agent_name, callback_context.user_content.parts[0].text )
